...
Transfinite Line {1, 7, 13, 19, 25, 31} = 17;
Transfinite Line {2, 8, 14, 20, 26, 32} = 2;
Transfinite Line {3, 9, 15, 21, 27, 33} = 19
Transfinite Line {3, 33} = 4;
Transfinite Line {4, 34} = 3;
Transfinite Line {10, 16, 22, 28} = 21;
Transfinite Line {5, 11, 17, 23, 29, 35} = 20;
Transfinite Line {5,  35} = 4;
Transfinite Line {6, 12, 18, 24, 30, 36} = 31;
Transfinite Line {41, 46, 42, 37 } =17;
Transfinite Line {40, 45,  43, 38 } =5;
